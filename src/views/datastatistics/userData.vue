...
<section>
    ...
    <el-row :span="24">
        ...
        <el-col :span="12" id="connectData" :style="{paddingLeft:'10px'}">
            <!-- <el-col :style="{width:'1px',height:'100%',backgroundColor:'#409eff'}"></el-col> -->
            <el-row>
                <!-- <el-date-picker v-model="value2" type="datetime" placeholder="选择日期时间" size="mini">
                </el-date-picker> -->
...
export default {
    data() {
        return {
            ...
            value1: new Date((new Date(new Date().getFullYear() + "-" + (new Date().getMonth() + 1) + "-" + new Date().getDate()).getTime()) + 8 * 60 * 60 * 1000),
            data: {},
            data1: [],
            data2: [],
            data3: [],
