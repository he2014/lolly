...
<section>
    ...
    <el-table :data="msg" style="width: 100%" border size="small">
        ...
        <el-table-column prop="price" label="付费金额" width="200">
         ...
         <el-input-number :disabled="identity=='用户'||scope.row.head==true||isPrice==3&&scope.row.price==0" v-model="scope.row.price" @change="priceChange" :min="0" :max="100000" label=""></el-input-number>
